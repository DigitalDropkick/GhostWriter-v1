...
- A final cold-start smoke run exposed a premature screenshot of the library-loading screen. The smoke helper now waits for that state to finish instead of relying solely on a one-second delay; a stuck loader times out as a failure.
