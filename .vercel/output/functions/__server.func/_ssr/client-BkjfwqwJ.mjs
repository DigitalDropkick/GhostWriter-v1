...
import { a as getBaseURL, i as PACKAGE_VERSION, r as GENERIC_OAUTH_ERROR_CODES, s as cn } from "./router-BTsMeNrw.mjs";
import { a as atom, i as onSet, n as STORE_UNMOUNT_DELAY, r as onMount, t as listenKeys } from "../_libs/nanostores.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/client-BkjfwqwJ.js
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 font-sans font-bold select-none transition-[background-color,transform,opacity] duration-150 ease-out disabled:opacity-50 disabled:pointer-events-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-moss active:scale-[0.99]", {
	variants: {
		variant: {
			primary: "bg-moss text-moss-fg hover:bg-moss-dark",
			secondary: "bg-paper text-ink border border-rule hover:bg-paper-deep",
