...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C0z2-KdU.mjs");
...
var manifest = { "10dbb69cee6c1110faefb949a6db02a534a007c9d17eaa87e115acec62ad84d8": {
	functionName: "shapeDictation_createServerFn_handler",
	importer: () => import("./ai-BttqWoSb.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BTsMeNrw.mjs").then((n) => n.t),
